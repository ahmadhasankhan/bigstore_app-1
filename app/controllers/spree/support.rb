module CurrentTenant
  ...
  def current_tenant
    ...
    if request.subdomain.eql?("limitless-sea-8975") || request.subdomain.eql?("venky") || request.subdomain.eql?("dhoni") || request.subdomain.eql?("tarun") || request.subdomain.eql?("shivank")
